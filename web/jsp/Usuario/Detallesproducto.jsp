                ...
                <div class="container">
                    ...
                    <div class="col-md-5">
                        <div class="product-details">
                            ...
                            <p> Precio :${producto.getPrecioestimado()}</p>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab3" class="tab-pane fade in">
                                    <div class="row">              
                                        ...
                                        <div class="col-md-3">
                                            <div id="review-form">
                                                <textarea class="input" id="txtcaja" placeholder="Tu comentario"></textarea>

                                                <button class="primary-btn" onclick="agregarcomentarios(${producto.getId_publicar()})">Enviar</button>
                                            </div>
                                        </div>
                                        <!-- /Review Form -->
                                    </div>
